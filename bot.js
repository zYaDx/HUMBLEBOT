...
client.on("message", async message => {
  ...
  .setDescription(`:x: You are not my owner -> <@your id> is my owner`)
  .setColor("22BF41");
  if(message.author.id !== "your id") return message.channel.send(ownerxxx);;
...
// All copyright for Sw3rD
 
// This bot coded from Sw3rD Special code you will never see a codes like this in github
