...
const serverStats = {
    guildID: '635936236409847834',
    ticketCategoryID: '636296074612441108'
...
client.on('message', async message => {
    ...
    if (message.channel.type !== 'text') {
        ...
        if (!active || !found) {
            ...
            channel.overwritePermissions("635939596273713230", { //Role id (when someone join my server get this role with id <<, i dont know how to change it for @everyone. This will prevent users to see the channel, only admins will see!
                VIEW_CHANNEL: false,
                SEND_MESSAGES: false,
                ADD_REACTIONS: false
            });//Toxic Codes
    ...
    if (support) {
        ...
        if (message.content.toLowerCase() === '/complete') { //Toxic Codes
            ...
            let inEmbed = new Discord.RichEmbed()
                ...
                .setColor('RANDOM')
            const staffChannel = client.channels.get('635951913472360507'); //Create a log channel and put id here
